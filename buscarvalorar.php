...
<div class="row">
  <div class="col-md-6">
      <form action="buscarvalorar.php" method="POST">
            <div class="form-group">
              <label class="control-label" for="textinput"><h4><font color="white">Buscar Casa o Experiencia:</font></h4>(puedes buscar por nombre o parte del nombre)</label>  
...
if(isset($_POST['submit']))
{
    ...
    $sql_casa="SELECT * FROM producto WHERE ((nombre_producto LIKE '%{$nombre_prod}%'))";
    ...
    while ($resultado_buscar2=mysqli_fetch_array($resultado_buscar,MYSQLI_BOTH)) {
      ...
      <form action="valorar.php" method="POST">
        ...
        <table> <form>
          <tr>
            <td>
              <input type="text" name="producto_seleccionado" value="'.$resultado_buscar2['nombre_producto'].'" style="visibility:hidden"> 
              <h4><font color="white">'.$resultado_buscar2['nombre_producto'].'</font></h4>
            </td>
            <td>
            <button type="submit" class="btn btn-success btn-lg btn-block">
            <a href="valorar.php?casa='.$resultado_buscar2['nombre_producto'].'">VALORAR</a></button></td> <br>
          </tr>
        </form>
        </table>
