...
{
    $nombre_borrado=$_POST['producto_a_borrar'];
    $sql_borrado="UPDATE producto SET borrado=1 WHERE nombre_producto='$nombre_borrado'";
          ...
          <div class="modal-dialog">
            <div class="modal-content">
               <div class="modal-header">
                  ...
                  <h4>Error al borrar producto</h4>
